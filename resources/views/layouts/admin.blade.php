        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('admin.indexCategory') }}">Liệt kê danh mục sản phẩm</a></li>
						<li><a href="{{ route('admin.createCategory') }}">Thêm danh mục sản phẩm</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('admin.indexBrand') }}">Liệt kê thương hiệu sản phẩm</a></li>
						<li><a href="{{ route('admin.createBrand') }}">Thêm thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('admin.indexProduct') }}">Liệt kê sản phẩm</a></li>
						<li><a href="{{ route('admin.createProduct') }}">Thêm sản phẩm</a></li>
                    </ul>
                </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('admin.indexCoupon') }}">Quản lý mã giảm giá</a></li>
                        <li><a href="{{ route('admin.createCoupon') }}">Thêm mã giảm giá</a></li>
                    </ul>
                </li>
