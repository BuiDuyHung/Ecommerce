                ...
                <tbody>
                    @foreach ($brands as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.editBrand', $item->id) }}" class="active styling-edit" ui-toggle-class="">
                                    <i class="fa fa-pencil-square-o text-success text-active"></i>
                                </a>
                                <a onclick="return confirm('Bạn có chắc chắn muốn xóa thương hiệu sản phẩm này?')" href="{{ route('admin.destroyBrand', $item->id) }}" class="active styling-edit" ui-toggle-class="">
