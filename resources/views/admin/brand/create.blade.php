                ...
                <div class="position-center">
                    <form role="form" action="{{ route('admin.storeBrand') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="brand_product_title" class="form-control title" id="brandProductTitle">
                        ...
                        <div class="form-group">
                            <label>Slug</label>
                            <input type="text" name="brand_product_slug" class="form-control slug" id="brandProductSlug">
                        ...
                        <div class="form-group">
                            ...
                            <textarea style="resize: none;" rows="5" type="text" name="brand_product_keywords" class="form-control" id="brandProductDesc"></textarea>
